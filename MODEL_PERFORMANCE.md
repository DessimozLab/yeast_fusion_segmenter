...
training on 2026-09-22. The class mapping exactly follows
...
| --- | --- | ---: | ---: | --- |
| `40x_only_yolov8n_seg_7class_50e` | `40x_only` | 1 / 12 | 0.0000 | [checkpoint](models/40x_only_yolov8n_seg_7class_50e.pt) |
| `all_czi_yolov8n_seg_7class_50e` | `all_czi` | 1 / 12 | 0.0000 | [checkpoint](models/all_czi_yolov8n_seg_7class_50e.pt) |
| `all_images_yolov8n_seg_7class_50e` | `all_images` | 3 / 115 | 0.00939 | [checkpoint](models/all_images_yolov8n_seg_7class_50e.pt) |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| `40x_only_yolov8n_seg_7class_50e` | `40x_only` | 1 / 54 | 0.0000 | 0.0000 | 0.0000 | 0.0000 |
| `all_czi_yolov8n_seg_7class_50e` | `all_czi` | 1 / 54 | 0.0000 | 0.0000 | 0.0000 | 0.0000 |
| `all_images_yolov8n_seg_7class_50e` | `all_images` | 3 / 117 | 0.0292 | 0.0200 | 0.0313 | 0.0159 |
